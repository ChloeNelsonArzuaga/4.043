...
class Display {
    ...
    show() {
      for (let i =0; i< this.displaySize; i++) {
        ...
        rect(i*this.pixelSize,2*this.pixelSize,this.pixelSize,this.pixelSize);
      }
      fill(color(255,255,255));
      rect((this.displaySize+1)*this.pixelSize,playerOne.height*this.pixelSize,this.pixelSize,this.pixelSize);
    }
